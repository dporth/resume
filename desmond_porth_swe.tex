...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeExperienceSubheading
        {My Chess Tournament}{2021 -- Present}
        {Pull Request LLC}{}
      \resumeSubSubheading
        {Python, SQL, Angular, Flutter, HTML, CSS, PowerShell, Git, Flask, ORM, Docker, ETL, REST APIs}{}
          \resumeItemListStart
            \resumeItem{Developed and maintain a cross-platform chess tournament management software.}
            \resumeItem{Implemented the API using REST architecture style and deployed all applications to the Azure cloud.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
